...
#define BSP_LCD_RST          (51)
#define BSP_LCD_BACKLIGHT    (50)
#define BSP_LCD_EN           (IO_EXPANDER_PIN_NUM_3)
#define BSP_LCD_TOUCH_INT    (GPIO_NUM_NC)
#define BSP_TOUCH_EN         (IO_EXPANDER_PIN_NUM_3)
/** @} */ // end of display
 ...
 *  @{
 */
#define BSP_LED_RED_IO       (55)
#define BSP_LED_BLUE_IO      (56)
/** @} */ // end of led
 ...
 *  @{
 */
#define BSP_BATTERY_VOLTAGE_CHANNEL     (ADC_CHANNEL_5)
 ...
 *
 * Camera interface
 * Supported camera sensors: OV3660
 ...
 *
 **************************************************************************************************/
#define BSP_IO_EXPANDER_ADDRESS    (ESP_IO_EXPANDER_I2C_TCA9554_ADDRESS_000)
#define BSP_IO_EXPANDER_ADDRESS_A  (ESP_IO_EXPANDER_I2C_TCA9554A_ADDRESS_000)
/**
